        ...
        toList([
          img(
            toList([
              ...
              src("/priv/static/images/me.jpg")
            ])
          )
        ])
      ),
      div(
        toList([class$("mt-3 sm:flex-1 sm:mt-0")]),
        toList([
          h1(
            toList([
              class$("font-bold text-xl md:text-2xl xl:text-3xl")
            ]),
            toList([text3("Vladislav Shakitskiy")])
          ),
          h2(
            toList([
              class$("font-semibold text-lg md:text-xl xl:text-2xl")
            ]),
            toList([text3("aka wiskiy")])
          ),
          p(
            toList([
              class$(
...
function view(model) {
  return fragment2(
    toList([
      view_navbar(),
      main(
        toList([class$("flex-1 flex items-center justify-center")]),
        toList([view_hero()])
      )
    ])
  );
...
function main2() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError(
      ...
      { value: $, start: 167, end: 216, pattern_start: 178, pattern_end: 183 }
    );
  }
  return void 0;
}
